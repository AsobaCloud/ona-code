...
export async function streamOpenAIChatCompletion({ baseUrl, apiKey, model, messages, tools, io, maxTokens = 8192, bufferOutput = true, num_ctx: numCtx }) {
  ...
  return {
    ...
    bufferedText: bufferOutput ? fullText : null,
    usage,
  }
}
